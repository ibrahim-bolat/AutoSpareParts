...
public class EmployeeSummaryCardDtoValidator : AbstractValidator<EmployeeSummaryCardDto>
{
    public EmployeeSummaryCardDtoValidator()
    {
        ...
        RuleFor(x => x.DefaultAddressDetail)
            .NotNull()
