...
public class GetIPAdressListByEndpointQueryHandler : IRequestHandler<GetIPAdressListByEndpointQueryRequest,
    GetIPAdressListByEndpointQueryResponse>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly IMapper _mapper;

    public GetIPAdressListByEndpointQueryHandler(IUnitOfWork unitOfWork, IMapper mapper)
    {
        _unitOfWork = unitOfWork;
        _mapper = mapper;
    }

    public async Task<GetIPAdressListByEndpointQueryResponse> Handle(GetIPAdressListByEndpointQueryRequest request,
        CancellationToken cancellationToken)
    {
        ...
        if (request.AreaName != null && request.EndpointId == 0)
        {
            ...
            if (endpointList != null)
            {
                ...
                return new GetIPAdressListByEndpointQueryResponse
                {
