...
public class AssignIPAddressListToEndpointsCommandHandler : IRequestHandler<
    AssignIPAddressListToEndpointsCommandRequest, AssignIPAddressListToEndpointsCommandResponse>
{
    private readonly IUnitOfWork _unitOfWork;

    public AssignIPAddressListToEndpointsCommandHandler(IUnitOfWork unitOfWork)
    {
        _unitOfWork = unitOfWork;
    }

    public async Task<AssignIPAddressListToEndpointsCommandResponse> Handle(
        AssignIPAddressListToEndpointsCommandRequest request, CancellationToken cancellationToken)
    {
        ...
        if (request.IPAreaName != null)
        {
            ...
            if (endpointList != null)
            {
                ...
                return new AssignIPAddressListToEndpointsCommandResponse
                {
