...
public class AssignRolesToEndpointsCommandHandler : IRequestHandler<
    AssignRolesToEndpointsCommandRequest, AssignRolesToEndpointsCommandResponse>
{
    private readonly IUnitOfWork _unitOfWork;
    private readonly RoleManager<AppRole> _roleManager;

    public AssignRolesToEndpointsCommandHandler(IUnitOfWork unitOfWork , RoleManager<AppRole> roleManager)
    {
        _unitOfWork = unitOfWork;
        _roleManager = roleManager;
    }

    public async Task<AssignRolesToEndpointsCommandResponse> Handle(
        AssignRolesToEndpointsCommandRequest request, CancellationToken cancellationToken)
    {
        ...
        if (endpoint != null)
        {
            ...
            return new AssignRolesToEndpointsCommandResponse
            {
