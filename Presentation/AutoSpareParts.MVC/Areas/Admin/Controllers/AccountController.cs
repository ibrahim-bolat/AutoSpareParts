using AutoSpareParts.Application.Features.Accounts.Commands.ConfirmEmailUserCommand;
using AutoSpareParts.Application.Features.Accounts.Commands.LoginUserCommand;
using AutoSpareParts.Application.Features.Accounts.Commands.RegisterUserCommand;
using AutoSpareParts.Application.Features.Accounts.Commands.UpdatePasswordUserCommand;
using AutoSpareParts.Application.Features.Accounts.Commands.UpdateUserCommand;
using AutoSpareParts.Application.Constants;
using AutoSpareParts.Application.CustomAttributes;
using AutoSpareParts.Application.Features.Accounts.Commands.EditPasswordAccountCommand;
using AutoSpareParts.Application.Features.Accounts.Commands.ExternalLoginUserCommand;
using AutoSpareParts.Application.Features.Accounts.DTOs;
using AutoSpareParts.Application.Features.Accounts.Queries.ForgetPasswordUserQuery;
using AutoSpareParts.Application.Features.Accounts.Queries.GetByIdForDetailProfileUserQuery;
using AutoSpareParts.Application.Features.Accounts.Queries.GetByIdUserQuery;
using AutoSpareParts.Application.Features.Accounts.Queries.GetEditPasswordAccountByIdQuery;
using AutoSpareParts.Application.Features.Accounts.Queries.GetExternalLoginAuthenticationPropertiesQuery;
using AutoSpareParts.Application.Features.Accounts.Queries.LogoutUserQuery;
using AutoSpareParts.Application.Features.Accounts.Queries.VerifyTokenUserQuery;
