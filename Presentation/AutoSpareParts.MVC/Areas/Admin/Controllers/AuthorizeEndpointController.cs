using AutoSpareParts.Application.Features.AuthorizeEndpoints.Commands.AssignIpListAuthorizeEndpointsCommand;
using AutoSpareParts.Application.Features.AuthorizeEndpoints.Commands.AssignRoleListAuthorizeEndpointsCommand;
using AutoSpareParts.Application.Features.AuthorizeEndpoints.DTOs;
using AutoSpareParts.Application.Features.AuthorizeEndpoints.Queries.GetAuthorizeEndpointsforAssignIpQuery;
using AutoSpareParts.Application.Features.AuthorizeEndpoints.Queries.GetAuthorizeEndpointsforAssignRoleQuery;
using AutoSpareParts.Application.Features.AuthorizeEndpoints.Queries.GetIpAdressesByEndpointQuery;
using AutoSpareParts.Application.Features.AuthorizeEndpoints.Queries.GetRolesByEndpointIdQuery;
