...
$(document).ready(function ($) {
    ...
    var tables = $("#employeesOfRoleTable").DataTable({
        "pageLength": 10,
        "ordering": true,
        "order": [[0, "asc"]],
        "info": true,
        ...
        "ajax": {
            "url": "/admin/role/employeesummarylistbyroleid?id=" + roleId,
            "type": "POST",
            "datatype": "json"
        },
        "columnDefs": [{
        ...
        "columns": [
            ...
            {"data": "Email", "name": "Email", "autoWidth": true},
            {
                "data": "Id", "width": "50px", "render": function (data) {
                    return  '<a class="btn btn-danger" onclick="removeEmployeeFromRole(' + data + ','+ roleId + ')"><i class="fa fa-trash-o">Rolden Çıkar</i></a>';
                }
            }
        ],
...
function removeEmployeeFromRole(employeeId,roleId) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/admin/role/removeemployeefromrole/',
                data: {
...
function ReloadTable() {
    ...
    $('#employeesOfRoleTable').DataTable().ajax.reload(null,false);
}
