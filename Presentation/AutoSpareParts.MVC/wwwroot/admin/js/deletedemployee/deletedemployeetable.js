...
$(document).ready(function ($) {
    var tables = $("#deletedEmployeeTable").DataTable({
        "pageLength": 10,
        "ordering": true,
        "order": [[0, "asc"]],
        "info": true,
        ...
        "ajax": {
            "url": "/admin/deletedemployee/getdeletedemployeelist",
            "type": "POST",
            "datatype": "json"
        },
        "columnDefs": [{
        ...
        "columns": [
            ...
            {"data": "Email", "name": "Email", "autoWidth": true},
            {
                "data": "Id", "width": "50px", "render": function (data) {
                    return  '<a class="btn btn-danger" onclick="SetActiveEmployee(' + data + ')"><i class="fa fa-trash-o">Aktif Et</i></a>';
                }
            }
        ],
...
function SetActiveEmployee(Id) {
    Swal.fire({
        ...
        if (result.isConfirmed) {
            $.ajax({
                type: "POST",
                url: '/admin/deletedemployee/setactiveemployee',
                data: {
                    employeed: Id
                },
                dataType: "json",
...
function ReloadTable() {
    ...
    $('#deletedEmployeeTable').DataTable().ajax.reload(null,false);
}
